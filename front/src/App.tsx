    ...
    >
      ...
      >
        <div className="flex justify-center items-center">
          <p className="text-white text-xl m-5">SpiderForm</p>
      ...
      <div
        className={`text-white flex flex-col justify-center items-center mt-32 gap-5 transition-all ease-in-out duration-200 ${selectedTemplates.length == 0
          ? ""
